    ...
    <div className="relative">
      ...
      <div className="flex flex-wrap gap-2 mt-4 print:hidden">
        <button
          ...
          onClick={handlePrint}
          disabled={!!saving}
          className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 min-h-[48px] text-sm font-medium text-slate-700 hover:bg-slate-50 active:bg-slate-100 disabled:opacity-50"
        >
