...
export default function GrantAccessButton({ requestId, onGranted }: Props) {
  ...
  return (
    <button
      ...
      onClick={handleGrant}
      disabled={loading}
      className="inline-flex items-center gap-1 rounded-none bg-emerald-600 px-2.5 py-1 text-xs font-medium text-white shadow-sm hover:bg-emerald-500 disabled:opacity-50"
    >
